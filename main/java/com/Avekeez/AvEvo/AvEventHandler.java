...
public class AvEventHandler implements IWorldGenerator{
	@Override
	...
	private void generateSurface(World world, Random random, int x, int z) {
		addOreSpawn(AvEvo.tastyRockOre, 0, Blocks.stone, world, random, x, z, 16, 16, 5 + random.nextInt(10), 8, 1, 256);
		
		int posX = x + random.nextInt(16);
		int posY = 50 + random.nextInt(35);
		int posZ = z + random.nextInt(16);
		new WorldGenEvGrass().generate(world, random, posX, posY, posZ);
    }
